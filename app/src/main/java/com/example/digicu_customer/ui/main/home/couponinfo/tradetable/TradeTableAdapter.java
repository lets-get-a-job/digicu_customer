...
public class TradeTableAdapter extends RecyclerView.Adapter<TradeTableAdapter.ViewHolder> {
    public interface OnItemClickLister {
        void onItemClick(View v, int pos, ProposalDataModel data);
    }

    private List<ProposalDataModel> data;
...
//        }
    ...
    public TradeTableAdapter(List<ProposalDataModel> data) {
        this.data = data;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        CouponDataModel couponDataModel = data.get(position).getCouponDataModel();
...
//        holder.getMileage().setText(couponDataModel.getCount() + "/" + couponDataModel.getGoal());
    ...
    public void setData(List<ProposalDataModel> data) {
        this.data = data;
    }
}
