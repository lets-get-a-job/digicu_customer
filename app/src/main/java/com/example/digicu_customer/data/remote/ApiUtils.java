...
public class ApiUtils {
    ...
    public static final String DEV_USER_BASE_URL = "http://10.0.2.2:3000";
    public static final String USER_BASE_URL = "https://virtserver.swaggerhub.com/lets-get-a-job/user-service/1.0.0/";

    public static final String DEV_COUPON_BASE_URL = "http://10.0.2.2:3000";
...
//        return RetrofitClient.getClient(USER_BASE_URL).create(DigicuService.class);
        return RetrofitClient.getClient(DEV_USER_BASE_URL).create(DigicuService.class);
    }
